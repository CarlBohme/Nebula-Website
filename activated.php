...
?>
          <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2><font color="white">Your Account Is Now Activated!<br>You May Now Log In.</h2>
            <a href="login.php">
...
?>
          <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2>Unable to update verification code</h2>
          </div> 
<?php
		} 
	}else{
?>
          <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h2>We can't find your verification code.</h2>
          </div> 
<?php
	}
?>
